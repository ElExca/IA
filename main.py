...
def operaciones_basicas():
    global a, b, deltaX, poblacion_inicial, deltaX_optima, tipo_optimizacion, poblacion_maxima_deseada  # Declarar como globales
    deltaX = float(input("Ingrese el valor de deltaX: "))
    a = float(input("Ingrese el valor de a: "))
    b = float(input("Ingrese el valor de b: "))
    poblacion_inicial = int(input("Ingrese el valor de la población inicial: "))
    poblacion_maxima_deseada = int(input("ingrese el numero maximo de la poblacion: "))
...
# Algoritmo genético
n, deltaX_optima,poblacion_maxima_deseada = operaciones_basicas()
...
prob_mutacion_individuo = float(input("Ingresa el la probabilidad de mutacion del individuo entre .0 y 1: "))
prob_mutacion_gen = float(input("Ingresa la probabilidad de mutacion del individuo: "))
...
for generacion in range(num_generaciones):
    ...
    if numero_aleatorio <= prob_mutacion_individuo:
        if prob_mutacion_gen <= numero_aleatorio2:
            hijos_mutados = [mutar_individuo(hijo, prob_mutacion_gen, deltaX_optima, funcion, a) for hijo in hijos_cruzados]
